...
namespace evd {
  ...
  bool RawDataDrawer::RunOperation(art::Event const& evt, OperationBaseClass* operation)
  {
    ...
    for (evd::details::RawDigitInfo_t const& digit_info : *digit_cache) {
      ...
      bool const bGood =
        rawopt->fSeeBadChannels || !channelStatus->IsBad(channel);
    ...
    for (const auto& rawDataLabel : rawopt->fRawDataLabels) {
      ...
      for (evd::details::RawDigitInfo_t const& digit_info : *digit_cache) {
        ...
        for (auto const& wid : wireids) {
          ...
          float pedestal = 0;
          if (rawopt->fPedestalOption == 0) {
            pedestal = pedestalRetrievalAlg.PedMean(ts, channel);
          }
          else if (rawopt->fPedestalOption == 1) {
            pedestal = hit.GetPedestal();
          }
  ...
  //......................................................................
  bool RawDataDrawer::ProcessChannelWithStatus(lariov::chStatus channel_status) const
  {
